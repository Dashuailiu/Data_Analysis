...
class FeatureSelector(object):
    ...
    --------
        ...
        labels : array or series, default = None
            ...
            These can be either binary labels
    ...
    record_low_importance : dataframe
        Records the lowest importance features not needed to
        reach the threshold of cumulative importance according to the gbm
    ...
    def identify_missing(self, missing_threshold):
        ...
        record_missing = pd.DataFrame(missing_series[missing_series >
                                                     missing_threshold]).reset_index().rename(
    ...
    def identify_single_unique(self):
        ...
        record_single_unique = \
            pd.DataFrame(unique_counts[unique_counts == 1]).reset_index().rename(
    ...
    def identify_all(self, selection_params):
        ...
        selection_params : dict
           ...
           ['missing_threshold', 'correlation_threshold', 'eval_metric', 'task', 'cumulative_importance']
    ...
    def remove(self, methods, keep_one_hot=True):
        ...
        Notes 
        --------
            - If feature importance is used,
              the one-hot encoded columns will be added to the data (and then may be removed)
    ...
    def plot_feature_importances(self, plot_n=15, threshold=None):
        ...
        plot_n : int, default = 15
            ...
            Defaults to 15 or the maximum number of features whichever is smaller
